...
## Modified date : 2019-08-20 15:31
## Author : DARREN
## Describe : not set
...
pip install -i https://pypi.tuna.tsinghua.edu.cn/simple --upgrade codecs
pip install -i https://pypi.tuna.tsinghua.edu.cn/simple --upgrade simhash
